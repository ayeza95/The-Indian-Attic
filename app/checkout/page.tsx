...
export default function CheckoutPage() {
    ...
    const [paymentOption, setPaymentOption] = useState<'cod' | 'online'>('online');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                toast.error(`Failed to place order: ${data.error || 'Unknown error'}${data.details ? ` (${data.details})` : ''}`);
            }
        } catch (error) {
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div
                                        className={`p-4 rounded-lg border-2 cursor-pointer flex justify-between items-center ${paymentOption === 'online' ? 'border-heritage-600 bg-heritage-50' : 'border-gray-200 hover:border-heritage-300'}`}
                                        onClick={() => setPaymentOption('online')}
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${paymentOption === 'online' ? 'border-heritage-600' : 'border-gray-300'}`}>
                                                {paymentOption === 'online' && <div className="w-2 h-2 rounded-full bg-heritage-600" />}
                                            </div>
                                            <div>
                                                <div className="font-semibold text-heritage-900">Pay Online (Razorpay)</div>
                                                <div className="text-sm text-gray-600">UPI, Cards, NetBanking</div>
                                            </div>
                                        </div>
                                        <div className="flex gap-1">
                                            <span className="text-[10px] bg-white border border-gray-200 px-1 rounded">UPI</span>
                                            <span className="text-[10px] bg-white border border-gray-200 px-1 rounded">VISA</span>
                                        </div>
                                    </div>

                                    <div
                                        className={`p-4 rounded-lg border-2 cursor-pointer flex justify-between items-center ${paymentOption === 'cod' ? 'border-heritage-600 bg-heritage-50' : 'border-gray-200 hover:border-heritage-300'}`}
                                        onClick={() => setPaymentOption('cod')}
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className={`w-4 h-4 rounded-full border-2 flex items-center justify-center ${paymentOption === 'cod' ? 'border-heritage-600' : 'border-gray-300'}`}>
                                                {paymentOption === 'cod' && <div className="w-2 h-2 rounded-full bg-heritage-600" />}
                                            </div>
                                            <div>
                                                <div className="font-semibold text-heritage-900">Cash on Delivery</div>
