...
export default function UserDetailPage({ params }: { params: Promise<{ userId: string }> }) {
    ...
    const handleBan = async () => {
        ...
        if (!confirm(`Are you sure you want to BAN this user? This will deactivate their account and delete all their products permanently.`)) {
            return;
        }
    ...
    const handleHideAllProducts = async (hide: boolean) => {
        if (!confirm(`Are you sure you want to ${hide ? 'HIDE' : 'UNHIDE'} all products for this artisan?`)) return;
