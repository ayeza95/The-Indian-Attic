                                    ...
                                    {!(item as any).manufactureDate && ['pending', 'confirmed', 'processing'].includes(order.status) && (
                                        <div className="flex gap-2 items-center mt-2">
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    if (confirm(`Set manufacture date to ${e.target.value}? This will notify the buyer.`)) {
                                                        handleSetManufactureDate(order._id, (item as any)._id, e.target.value);
                                                    }
                                                }}
                                            />
                                        </div>
                ...
                {['pending', 'confirmed', 'processing'].includes(order.status) && (
                    <div className="flex gap-2">
                        ...
                        <Button
                            ...
                            onClick={() => {
                                if (confirm('Are you sure you want to decline this order? A refund will be triggered.')) {
                                    handleUpdateStatus(order._id, 'cancelled', 'refunded');
                                }
                            }}
                        >
