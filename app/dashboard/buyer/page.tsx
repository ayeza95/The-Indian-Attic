...
import { User, ShoppingBag, MessageSquare, Settings, Heart, AlertTriangle, FileText } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gradient-to-b from-heritage-50 to-white">
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <Link href="/dashboard/buyer/tenders">
                        <Card className="hover:shadow-lg transition-shadow cursor-pointer">
                            <CardHeader>
                                <div className="flex items-center space-x-2">
                                    <FileText className="h-5 w-5 text-heritage-600" />
                                    <CardTitle>My Tenders</CardTitle>
                                </div>
                                <CardDescription>
                                    Create and manage your artifact tenders
                                </CardDescription>
                            </CardHeader>
                        </Card>
                    </Link>
