                ...
                <div className="absolute inset-0 bg-gradient-to-b from-black/50 via-black/70 to-transparent flex items-center justify-center text-center px-4">
                    <div className="max-w-4xl space-y-6 animate-in fade-in zoom-in duration-1000">
                        ...
                        <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center">
                            <Link href="/products">
                                <Button size="lg" className="bg-heritage-500 hover:bg-heritage-600 text-white min-w-[200px] text-lg py-6 glow-shadow">
                                    Explore Collection
                                </Button>
                            </Link>
                            <Link href="/swadesibox">
                                <Button size="lg" variant="outline" className="bg-white/10 backdrop-blur border-white text-white hover:bg-white hover:text-heritage-900 min-w-[200px] text-lg py-6">
                                    Join SwadesiBox
                                </Button>
                            </Link>
                        </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2 space-y-8">
                            ...
                            <Link href="/about">
                                <Button className="bg-gold-500 text-heritage-950 hover:bg-gold-400 px-8 py-6 rounded-none text-lg font-medium tracking-wide mt-4">
