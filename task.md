...
- [x] Investigate and fix artisan tender "View Details" button
- [/] Investigate and fix admin dashboard tenders view
- [/] Investigate and fix "Submit Proposal" button persistence after application
